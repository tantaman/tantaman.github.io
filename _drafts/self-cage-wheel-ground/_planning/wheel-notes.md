Now we come to the hardest part. Secifying exactly what makes the wheel turn.

The cage leaned heavily into the assumption that power had selected the selves currently present without defining power or demonstrating the statement's truth.

The cage chapters also only showed _one_ cage. The modern cage. There have been many cages through time:
- The Catholic church's exploitation of its believers
- The gaze of the Village
- The tyranny of the anarchist with the most influence
- ...

Whenever the current cage is genuinely broken or escaped, the wheel turns to manufacture the next cage. What must also be shown, then, is the inevitability of this process. Regardless of material comforts, institutions, or the people involved. The mathematical necessity of the turn.

This chapter will use a contingent definition of power. One that fits the anthropological record but, because it is evidence based, could be argued to be otherwise. One that leans on the laws of thermodynamics but, because it does so, could be argued to be otherwise. Once we've taken that analysis as far as it will go, we'll find the final law. The one that is logically necessary by the nature of being a self into a world of other selves. The one that cannot be solved by material abundance or any configuration of items within the cage. Something that goes beyond Girard, Heidegger, Foucault, Marx and every other thinker we've leaned on up to now.

1. Start with life as value capture
2. Humans require other humans for value capture
3. Creates a network
4. Must be legible to the network
5. Modelable
6. Eventually performing for the network
