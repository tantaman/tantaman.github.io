...
The Christian eschaton was outside time. It would arrive when the Father decided — about that day or hour no one knows. This was not epistemic humility. It was load-bearing architecture. The end of history was not a human project. Which meant that the suffering before it arrived did not require a perpetrator to be found and neutralized. The excluded did not need a villain — they needed a witness and a promise. There was only the wait, located inside a narrative that contained it, given by a promise not contingent on human performance. The prophet could name injustice without needing its removal to be the measure of his faithfulness, because the removal was not his to accomplish. And beneath that architecture stood resurrection: the demonstration, already given, that the excluded one is vindicated — not eventually, not pending sufficient solidarity, but actually, by an act outside the system that the system could not undo.

The secular eschaton came inside time. This felt like an advance — no longer waiting for a God who may not come, but building what is required. It was not an advance. If the kingdom can be built, then its non-arrival requires explanation. Something is preventing it. Someone is preventing it. The villain is not optional — he is structurally necessary. The gap between the world as it is and the world as it ought to be must be filled by an enemy, because the gap can no longer be held inside a narrative that absorbs it without demanding resolution. Whiteness. Patriarchy. Capital. The logic of the system. The specific villain shifts; the villainous slot in the structure is permanent. Remove one enemy and the grammar generates another, because the grammar cannot function without one. This is not a corruption of the vision. It is the inevitable consequence of relocating the eschaton inside history and removing the act that had already, from outside, bent the arc.
...
The identifying self has made correct alignment the measure of her moral worth. Not a task she performs on top of a given identity, but the substance of the identity itself. She is as worthy as she sees clearly, as valuable as her opposition is uncompromised, as real as her identification is complete. Which means the spiral is not only about purity. It is about worth. Someone always sees more clearly — which means someone is always more worthy. The rival who identifies more completely is not just more politically correct. She is, in the formation's terms, more of a person. The standard does not just move. It moves while carrying everything that matters.

The Sunday edge is the experience of a self whose worth is produced by the correctness of its seeing — scanning all week, finding plenty, opposing what she could, and arriving at Sunday having moved nothing that matters. Not because she failed. Because the grammar does not contain a condition under which enough has been moved. The eschaton that was brought inside history cannot arrive without a perpetrator finally neutralized, and there is always another perpetrator behind the last one. The promise that was supposed to make this livable — the promise that the arc bends, that the last shall be first, that the excluded will be vindicated — was only ever load-bearing when it came from outside. When resurrection was the ground, not the goal. Handed to her as a human project, it does not comfort. It indicts. And the worth it promises is therefore always withheld, always conditional, always one clearer seeing away from being real.
...
The achievement subject lost the *imago Dei* — worth given prior to output, the ground that made Sabbath structurally possible. The confessing animal lost grace — not the naming, but the prior act that made the naming complete, the authority outside the self that could receive the disclosure and discharge it. The identifying self lost the extra-historical eschaton and the resurrection that undergirded it — the vindication already given, from outside, that made the suffering bearable without requiring a perpetrator to be found.

Three different amputations. Three different shapes of motion without arrival. What they share is not a single missing thing but a single missing structure: something that came before, that held, that was not produced by the self's own effort. The floor, the grace, the promise outside time. Each was given. Each was lost. Each left behind a formation that runs the motion the given thing once made coherent — and cannot stop, because stopping would mean confronting what the motion was always avoiding.
