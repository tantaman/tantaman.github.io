...
import deeplyNested from '../static/blog-assets/deeply-nested-updates/deeply-nested.png';
import deeplyNestedReRender from '../static/blog-assets/deeply-nested-updates/deeply-nested-re-render.png';
...
<Figure url={deeplyNested} description="App Components" />
...
> The current state software engineering is in is a false dichotomy between immutable & functional vs mutable & oo. I explore this more in [Missing Mutation Primitives](2021-12-16-Missing-Mutation-Primitives) as well as [Understanding Reference Equality](2021-12-17-Object-Identity).
...
I've built out a [React Hook](https://reactjs.org/docs/hooks-intro.html) framework, based on the work outlined here, which I'll be publishing as part of [Aphrodite](https://github.com/tantaman/aphrodite).
