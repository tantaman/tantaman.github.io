    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(li0, "class", "svelte-rgoo9c");
    			add_location(li0, file, 7, 2, 64);
    			attr_dev(li1, "class", "svelte-rgoo9c");
    			add_location(li1, file, 8, 2, 81);
    			attr_dev(li2, "class", "svelte-rgoo9c");
    			add_location(li2, file, 9, 2, 99);
    			add_location(ul, file, 6, 0, 56);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$2, 32, 2, 520);
    			attr_dev(main, "class", "svelte-1e9puaw");
    			add_location(main, file$2, 31, 0, 511);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
