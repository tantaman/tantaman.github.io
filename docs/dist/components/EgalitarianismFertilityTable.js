    ...
    return (React.createElement("div", { style: {
        ...
        React.createElement("div", { style: { overflowX: 'auto' } },
            React.createElement("table", { style: {
                ...
                React.createElement("tbody", null, data.map((row, i) => (React.createElement("tr", { key: i, style: {
                        background: i % 2 === 0 ? 'transparent' : `${T.bg}44`,
                    } },
                    React.createElement("td", { style: Object.assign(Object.assign({}, cellBase), { color: T.text, fontWeight: 600, fontSize: 14 }) }, row.community),
                    React.createElement("td", { style: cellBase },
                        React.createElement("span", { style: pill(row.egal) }, row.egal)),
                    React.createElement("td", { style: Object.assign(Object.assign({}, cellBase), { fontFamily: T.mono, fontSize: 14, fontWeight: 600, color: T.text }) }, row.tfr),
                    React.createElement("td", { style: Object.assign(Object.assign({}, cellBase), { fontSize: 13, color: row.trendColor, fontStyle: 'italic' }) }, row.trend))))))),
        React.createElement("div", { style: {
                padding: '10px 18px',
