        ...
        React.createElement("div", { style: { padding: '16px 8px 8px' } },
            React.createElement(ResponsiveContainer, { width: "100%", height: 320 },
                React.createElement(LineChart, { data: data, margin: { left: 10, right: 20, top: 10, bottom: 5 } },
                    ...
                    React.createElement(XAxis, { dataKey: "edu", tick: { fill: T.textDim, fontSize: 11, fontFamily: T.mono }, axisLine: { stroke: T.border }, tickLine: { stroke: T.border } }),
                    React.createElement(YAxis, { domain: [1.2, 2.8], tick: { fill: T.textDim, fontSize: 10, fontFamily: T.mono }, axisLine: { stroke: T.border }, tickLine: { stroke: T.border }, tickFormatter: (v) => v.toFixed(1), label: {
                    ...
                    React.createElement(Line, { type: "monotone", dataKey: "israel", name: "Israel (Jewish women)", stroke: T.teal, strokeWidth: 2.5, dot: { r: 4, fill: T.surface, stroke: T.teal, strokeWidth: 2 }, activeDot: { r: 6, fill: T.teal } }),
                    React.createElement(Line, { type: "monotone", dataKey: "oecd", name: "OECD average", stroke: T.purple, strokeWidth: 2.5, dot: { r: 4, fill: T.surface, stroke: T.purple, strokeWidth: 2 }, activeDot: { r: 6, fill: T.purple } })))),
        React.createElement("div", { style: {
                padding: '10px 18px',
