...
export function formatDescription(desc) {
  ...
  return parts.map((part, i) => {
    if (part === "Current:") return _jsx("span", {
      style: {
        color: "#5cb85c",
        fontWeight: 700,
        fontStyle: "normal"
    ...
    if (part === "Mamdani:") return _jsx("span", {
      style: {
        color: "#e85d4a",
        fontWeight: 700,
        fontStyle: "normal"
  ...
  return _jsxs("div", {
    ...
    children: [_jsxs("div", {
      ...
      children: [_jsx("label", {
        ...
        children: [typeof value === "number" && value % 1 !== 0 ? value.toFixed(2) : value.toLocaleString(), unit]
      })]
...
export function simulate(params) {
  const {budget, budgetGrowth, numMillionaires, millionaireTaxRate, corpTaxRate, propertyTaxRate, migrationSensitivity, pensionGrowthRate, benefitsGrowthRate, salaryGrowthRate, revenueGrowth, yearsToProject} = params;
  ...
  for (let i = 0; i <= yearsToProject; i++) {
    ...
    const t = i;
    const annualMigrationRate = taxDelta > 0 ? migrationSensitivity * taxDelta * 0.012 + (propDelta > 0 ? propDelta * 0.003 : 0) : Math.max(taxDelta * 0.005, -0.01);
    if (i > 0) {
...
export function CustomTooltip({active, payload, label}) {
  ...
  return _jsxs("div", {
    ...
    children: [_jsx("div", {
      ...
      children: [p.name, ": ", typeof p.value === "number" && p.value > 500 ? fmtK(p.value) : fmt(p.value)]
    }, i))]
  });
}
export function NYCBudgetSimulator() {
  ...
  const set = useCallback(key => val => setParams(p => ({
    ...p,
    [key]: val
  })), []);
  const applyMamdani = () => {
      ...
      children: [_jsxs("div", {
        ...
        children: [_jsxs("button", {
          ...
          children: [_jsxs("p", {
            ...
            children: ["NYC spends more per capita than almost any city on earth — comparable to the ", _jsx("em", {
              children: "entire state of Florida"
            }), " with a third the population — yet delivers middling outcomes. The city spends ", _jsx("span", {
              style: {
                color: "#e85d4a",
                fontWeight: 600
              },
            ...
            children: ["The core problem: ", _jsx("span", {
              style: {
                color: "#e088a8",
                fontWeight: 600
              },
            ...
            }), " for 302,000 city employees consume an ever-growing share of the budget. These are ", _jsx("em", {
              children: "exactly"
            }), " the costs a socialist coalition built on public-sector unions cannot cut. The unfunded retiree healthcare liability alone is ", _jsx("span", {
              style: {
                color: "#e85d4a",
                fontWeight: 600
              },
        ...
        children: [_jsxs("div", {
          ...
          children: [_jsxs("div", {
            ...
            children: "Budget vs Revenue · Pension & Salary Overlay"
          }), _jsx("div", {
            style: {
            ...
            children: _jsxs("table", {
              ...
              children: [_jsx("thead", {
                children: _jsx("tr", {
                  ...
                  children: ["Bracket", "Federal", "State", "City", "Total Rate", "Share of City Rev"].map(h => _jsx("th", {
                    style: {
                      textAlign: "left",
                      padding: "8px 10px",
                      color: "#8a7e6e",
                ...
                children: [brackets.map((b, i) => _jsxs("tr", {
                  style: {
                  ...
                  children: [_jsx("td", {
                    ...
                    children: [b.totalRate, "%"]
                  }), _jsxs("td", {
                    style: {
                      padding: "8px 10px",
                      color: "#d4a556"
                    },
                    children: [b.shareOfRevenue, "%"]
                  })]
                }, i)), _jsxs("tr", {
                  style: {
                  ...
                  children: [_jsx("td", {
                    ...
                    children: [params.corpTaxRate.toFixed(2), "%"]
                  }), _jsxs("td", {
                    style: {
                      padding: "8px 10px",
                      color: "#f0e6d3",
                    ...
                    children: [(21 + 7.25 + params.corpTaxRate).toFixed(1), "%"]
                  }), _jsx("td", {
                    style: {
                      padding: "8px 10px",
                      color: "#6b6157"
            ...
            children: ["FY", lastYear.year, " Projected Breakdown"]
          }), _jsxs("div", {
            style: {
              display: "flex",
              gap: 10,
