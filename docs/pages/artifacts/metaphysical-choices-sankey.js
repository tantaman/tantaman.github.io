...
var science_default = {
  ...
  explanatoryNote: {
    ...
    text: '<span style="color: #d48a4e">Bacon</span> and <span style="color: #cc6644">Descartes</span> made a practical choice \u2014 study only what you can measure and manipulate. This produced genuine knowledge. But the bracket hardened into dogma: if you can\u2019t measure it, it doesn\u2019t exist. <span style="color: #b8924a">Newton</span> at 40 genuinely held both \u2014 alchemist and mechanist \u2014 paralleling Catholicism. <span style="color: #8B72BE">Quantum mechanics</span> at 68 broke the mechanist framework from within: the observer re-entered. The thin <span style="color: #3ac5b5">teal stream</span> \u2014 complexity science, deep ecology, enactivism \u2014 represents science recovering participation. The <span style="color: #e84450">red zone</span> is Bacon\u2019s vision fully realized: knowledge as domination, nature as resource, the human as object.'
  }
};
...
var education_default = {
  ...
  explanatoryNote: {
    ...
    text: '<span style="color: #2ee8d0">Bildung</span> at 90 is the Eckhart of education \u2014 self-cultivation as encounter with culture, the person unfolding into wholeness. <span style="color: #d48a4e">The Prussian model</span> at 15 is the fork \u2014 compulsory state schooling designed to produce obedient citizens and factory workers. <span style="color: #8aaa6a">Dewey</span> at 55 is this diagram\u2019s Catholicism \u2014 genuinely tried to hold both formation and function, with mixed results. The contemporary teal stream \u2014 <span style="color: #3ac5b5">classical schools</span>, <span style="color: #7a9aaa">Great Books seminars</span>, Charlotte Mason homeschoolers \u2014 is the contemplative remnant: small, underfunded, and irreplaceable. The <span style="color: #e84450">red zone</span> is education with the education removed \u2014 credential production, content delivery, and human capital development.'
  }
};
...
var theology_default = {
  ...
  explanatoryNote: { heading: "How to read this:", text: 'Higher = closer to Eckhart (interiority, detachment, participation, apophatic unknowing). Lower = the inversion (exteriority, acquisition, contractual God, propositional certainty). The five movements in the bottom-right are spaced for readability but all score \u2264 5 \u2014 they are each a distinct flavor of the same fundamental inversion. <span style="color: #b8924a">Catholicism</span> at 55 genuinely holds both streams. <span style="color: #7a6aad">Eastern Orthodoxy</span> at 75 retains more participatory DNA. Churches like McLean Bible sit in American Evangelicalism (~14).' },
  tooltipWidth: 380,
  tooltipHeight: 300
};
...
var psychology_default = {
  ...
  explanatoryNote: { heading: "The same shape:", text: `<span style="color: #2ee8d0">Jung</span> at 88 plays Eckhart's role \u2014 the psyche as unfathomable depth, individuation as participatory transformation. <span style="color: #d48a4e">Behaviorism</span> at 8 is the nominalist fork \u2014 there IS no inner life, only stimulus and response. <span style="color: #8B72BE">Freud</span> at 65 parallels Catholicism \u2014 recovered depth but reduced it to mechanism (drives, hydraulics). <span style="color: #cc5544">CBT</span> at 20 is the Westminster Confession of psychology \u2014 swap bad propositions for correct ones. The bottom row is the prosperity gospel of the mind: optimize, hack, subscribe, produce. The thin <span style="color: #3ac5b5">teal stream</span> \u2014 somatic work, psychedelic therapy, depth analysis \u2014 persists but is dwarfed by the $15B self-help industry.` },
  tooltipWidth: 350,
  tooltipHeight: 192
};
...
var buddhism_default = {
  ...
  explanatoryNote: { heading: "The deepest irony:", text: `Buddhism's core teaching is that <em>craving causes suffering</em>. The contemporary inversion uses Buddhist technique to <em>optimize craving</em> \u2014 meditate so you can want more effectively. <span style="color: #3ac5b5">Nagarjuna</span> at 95 and <span style="color: #2ee8d0">Dzogchen</span> at 92 are Buddhism's Eckhart \u2014 emptiness that dissolves even the concept of emptiness. <span style="color: #cc5544">Nichiren</span> at 12 is the fork \u2014 chant the sutra title for material results, exactly paralleling the prosperity gospel. <span style="color: #993a3a">Buddhist nationalism</span> at 3 weaponizes compassion for ethnic violence. The <span style="color: #e84450">bottom row</span> \u2014 McMindfulness, meditation apps, Wisdom 2.0 \u2014 is renunciation repackaged as consumption. The tradition that began with a man leaving his palace to sit under a tree now sells subscriptions for $14.99/month.` }
};
...
var islam_default = {
  ...
  explanatoryNote: { heading: "The parallel structure:", text: `<span style="color: #2ee8d0">Ibn Arabi</span> (1165\u20131240) and <span style="color: #d48a4e">Ibn Taymiyyah</span> (1263\u20131328) are almost exact contemporaries of Eckhart and Ockham \u2014 and play identical roles. The fork from participatory metaphysics (wahdat al-wujud) to divine voluntarism produces the same cascade: literalism \u2192 puritanical reform \u2192 political instrumentalization \u2192 apocalyptic violence. <span style="color: #8aaa6a">Al-Ghazali</span> at 58 plays a role analogous to Catholicism \u2014 holding both streams. <span style="color: #7a6aad">Shia Islam</span> preserved more mystical DNA through Irfan, paralleling Eastern Orthodoxy's preservation of theosis. The thin <span style="color: #3ac5b5">teal stream</span> survives in Sufi orders, Iranian seminaries, and diaspora communities \u2014 but is vastly outnumbered.` },
  tooltipWidth: 340,
  tooltipHeight: 192
};
...
var economics_default = {
  ...
  explanatoryNote: {
    ...
    text: `<em>Chrematistike</em> \u2014 money-making as its own end \u2014 is "unnatural" because it has no inherent limit. <em>Oikonomia</em> aims at sufficiency for the good life; chrematistike aims at infinite accumulation. <span style="color: #8aaa6a">Adam Smith</span> at 55 is the bridge \u2014 moral philosopher who also unleashed the market; <em>Theory of Moral Sentiments</em> and <em>Wealth of Nations</em> are the two halves of his Catholicism. The <span style="color: #cc5544">Marginalist Revolution</span> at 12 is the nominalist fork \u2014 value becomes subjective utility, economics becomes calculus, the human becomes a maximizing function. The <span style="color: #b8924a">Austrian School</span> at 38 preserves genuine anti-instrumentalist insight \u2014 distributed knowledge, anti-planning \u2014 but still treats the human as a maximizer. <span style="color: #b8924a">Degrowth</span> at 35 correctly diagnoses infinite growth on a finite planet but has no viable theory of transition and is vulnerable to capture by power. <span style="color: #2ee8d0">Ostrom</span> and the commons revival proved communities can manage shared resources without either state or market \u2014 the thin teal stream. <span style="color: #e84450">Algorithmic trading</span> at 1: machines trading with machines, humans fully removed. Aristotle's nightmare.`
  }
};
