...
This splitting of plans begs the question of we can do a global optimization across all plans and create a single plan of execution.

# Optimization

That brings us to query plan optimization. To be written in a follow up post!
