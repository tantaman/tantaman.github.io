...
1.  A physicist or mathematician develops a theory to solve a specific problem or unify existing knowledge.
    
2.  The theory, to be internally consistent, _requires_ something extra—an entity, a phenomenon, a particle—that wasn’t part of the original goal.
    
3.  This “something extra” is completely beyond the detection capabilities of the time.
    
4.  Years or decades later, new instruments confirm the prediction.
    

This happens not once or twice, but _systematically_ across the history of science. The sheer repetition of this pattern demands explanation.
...
Dirac constructed his equation, and it worked beautifully. It automatically predicted that electrons should have spin (an intrinsic angular momentum that had been added by hand to earlier theories). But the equation had a troubling feature: it seemed to require solutions with _negative energy_.
...
These ratios made no sense unless inheritance worked through discrete, particulate units—what we now call genes—that combined and segregated according to specific rules. Mendel had no microscope that could see a gene. He had no concept of DNA. He simply observed that inheritance behaved _as if_ discrete units existed.
...
_The equations see further than we do. Our task is to trust them—and to keep building better instruments._
