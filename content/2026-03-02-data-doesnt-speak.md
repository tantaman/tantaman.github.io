...
**Hans-Georg Gadamer, *Truth and Method* (1960).** The philosophical source for the essay's central argument. Gadamer's hermeneutic circle — the claim that all understanding proceeds from a prior framework of understanding that shapes what can be seen — is what the essay demonstrates operating inside empirical research. His concept of *wirkungsgeschichtliches Bewusstsein* (historically-effected consciousness) names the condition the essay describes: the researcher who believes she is "just following the data" is the one most fully captured by her formation, because she cannot see it as a formation.

**Thomas Kuhn, *The Structure of Scientific Revolutions* (1962).** Kuhn's demonstration that science operates within paradigms — frameworks that determine what counts as a problem, what counts as evidence, and what counts as a solution — provides the epistemology of science version of the essay's claim. Normal science is puzzle-solving within an unquestioned framework. The questions that lead to paradigm shifts are not questions the current paradigm knows how to ask. The economist who concludes subsidies weren't large enough is doing normal science within the optimization paradigm. The question "what if the framework itself is the problem?" is a paradigm-shift question.

**Michael Polanyi, *Personal Knowledge* (1958).** Polanyi's argument that all knowledge — including scientific knowledge — rests on tacit commitments that cannot themselves be made fully explicit provides the epistemological architecture for the essay's claim that "there is no unformed questioner." The scientist's judgment, intuition, and formational tradition are not contaminants to be eliminated but preconditions for any knowing at all. The demand to achieve a "view from nowhere" is itself a product of a specific formation — one that treats disembodied objectivity as the ideal and embodied, situated knowing as a defect.

**Pierre Bourdieu, *Science of Science and Reflexivity* (2001).** Bourdieu turns his sociological apparatus on the scientific field itself, showing how the institutional structures of academic research — funding incentives, publication pressures, disciplinary boundaries, prestige hierarchies — shape what questions get asked, what methods are considered legitimate, and what findings get amplified. The essay's claim that "optimizers studying optimization, using optimization's tools, within optimization's institutions" cannot see the framework as a framework is Bourdieu's reflexive sociology applied to demography.

**Lorraine Daston & Peter Galison, *Objectivity* (2007).** Daston and Galison trace the history of scientific objectivity as a concept — showing that what counts as "objective" has changed dramatically across centuries, and that each regime of objectivity was shaped by specific moral and epistemic commitments its practitioners could not see as commitments. The modern ideal of mechanical objectivity (eliminate the observer) is itself a historical product, not a timeless standard. The essay's argument that the demand to "just follow the data" is a formation masquerading as rigor finds its intellectual history here.