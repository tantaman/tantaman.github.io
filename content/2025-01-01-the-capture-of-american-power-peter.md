...
Thiel’s business philosophy, articulated most clearly in his book _Zero to One_ (2014), is explicitly anti-competitive—which is to say, it seeks to escape mimetic rivalry rather than win it:

> “Competition is for losers.”
> 
> “All happy companies are different: each one earns a monopoly by solving a unique problem. All failed companies are the same: they failed to escape competition.”

This sounds like contrarian business advice, but it is Girardian strategy applied to markets. Competitive markets are mimetic bloodbaths—internal mediation at industrial scale, everyone imitating everyone else, margins driven to zero, no one achieving escape velocity. Monopoly is the only position from which you can remain an _externally_ mediated model: others may imitate your general posture of success, but there is no contested object, no direct competition, no proximity that would collapse the relationship into symmetric rivalry. The monopolist is imitated but never rivaled.
...
-   **Deploy violence**: military force, immigration enforcement, federal prosecution, incarceration
    
-   **Protect property**: enforce contracts, defend intellectual property, maintain the legal infrastructure of accumulation
    
-   **Manage the border**: control labor supply through immigration policy
    
-   **Maintain monetary credibility**: the dollar as reserve currency, Federal Reserve policy, sanctions power
    

What it increasingly cannot do:

-   Build infrastructure at reasonable cost and speed
    
-   Provide services directly (most are contracted out)
    
-   Regulate technology effectively (captured, outpaced, or defunded)
    
-   Shape economic production (offshored, automated, platform-mediated)
    
-   Control information flows (that power has migrated to platforms)
...
-   **Eliminated or reduced**: Regulatory agencies (EPA, FTC, consumer protection), redistributive programs (attempts on Medicare, Social Security, federal education), public alternatives to private provision, civil rights enforcement mechanisms
    
-   **Preserved or enhanced**: Defense and intelligence apparatus, border enforcement, property rights infrastructure, federal prosecution capacity
    

This is not a minimal state in the libertarian sense. It is a _praetorian_ state—strong in violence, weak in governance, aligned with oligarchic interests.
...
This framework explains the apparent contradictions in Thiel’s public positions. The _exoteric_ teaching is libertarianism: small government, competitive markets, individual freedom, federalism. This is the public-facing ideology that recruits allies, provides rhetorical cover, and makes the project legible as a recognizable political faction.

The _esoteric_ teaching—visible in “The Straussian Moment” and in the actual pattern of investments, alliances, and policy outcomes—is something else entirely: monopoly power, surveillance infrastructure, state capture, and the recognition that founding violence is both inevitable and necessary.
...
Facebook’s business model provides the clearest proof of this thesis. The advertising industry distinguishes between two fundamentally different functions: _demand capture_ and _demand generation_. Google Search is the paradigmatic demand-capture platform—it reaches people who already want something and are actively searching for it. The desire pre-exists; the platform merely harvests it. Facebook, by contrast, is what advertisers call a _demand generation_ platform—it creates desire that did not previously exist.
...
-   **Speech**: What can be said, by whom, to what audience, with what amplification or suppression
    
-   **Commerce**: Who can sell, who can buy, on what terms, with what payment processing
    
-   **Information**: What people see, in what order, with what framing, from what sources
    
-   **Labor**: Who works, under what classification, with what protections (or lack thereof)
    
-   **Identity**: How people are verified, tracked, credentialed, and represented
...
-   Facebook/Instagram began frantically imitating TikTok’s short-video format (Reels)
    
-   The algorithm shifted from friend-based feeds to TikTok-style “discovery” content
    
-   Younger users migrated away from Meta platforms
    
-   Zuckerberg went from setting the template to chasing it
...
-   Monopoly positions achieved in infrastructural technologies—payments, social networking, data analytics, surveillance
    
-   Federal government captured and hollowed out—positive capacity eliminated, coercive capacity preserved
    
-   Platform control established over speech, commerce, information—though TikTok’s rise reveals this control is contested, particularly among younger users
...
The _outcome_ for ordinary people may converge—surveilled, algorithmically managed, desires triangulated through platforms—but the _structure_ differs. China is techno-authoritarian state capitalism. The US is evolving toward techno-feudal oligarchy with a praetorian rump state. These are not identical systems but they are _compatible_ systems—and crucially, they are systems whose ruling classes can do business with each other even while performing civilizational conflict for domestic audiences.
...
This does not mean geopolitical conflict is fake or that great power competition has no real stakes. Wars can start, people can die, and the outcomes matter. But it does suggest that the _framing_ of this conflict as a battle between fundamentally different systems is misleading. Both systems are converging on platform-mediated techno-authoritarianism. The question is not _whether_ this future arrives but _which configuration of elites_ administers it.
...
The investigation: whether their _public statements_ criticizing ICE constituted obstruction of federal law enforcement.
...
> 
> — _Things Hidden Since the Foundation of the World_, 1978

---

_Essay synthesized from conversation on December 26, 2025_
