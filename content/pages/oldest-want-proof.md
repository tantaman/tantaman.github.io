...
**D1. Subject** — A locus of experience that is not exhausted by any finite description of it. Denote the full subject *S*.
...
**A1. Embodied finitude.** Every subject *S* is physically embodied. Physical embodiment is finite: *S* occupies a bounded region of spacetime and cannot simultaneously occupy all positions.
...
**A3. Positioning requirement.** For *S* to enter Φ_B, *S* must occupy a position accessible to Φ_B. This requires *S* to take a form *F(S)* compatible with *B*'s attentional field. Call this the positioning requirement.

**A4. Lossiness of form.** Every projection *F* is lossy: *F(S) ⊊ S* for all physically realizable *F*. No finite form exhausts a subject. (This follows from D1 and D3: if *F* were lossless, *S* would be exhausted by a finite description, contradicting D1.)
...
**Lemma 1. Recognition is always recognition of a form, not of the subject.**
...
**Lemma 3. The act of seeking recognition produces the condition that defeats it.**
...
**Lemma 4. Generosity of attention does not resolve the problem.**
...
**Theorem. The Want is structurally unsatisfiable by any finite embodied other.**
...
**C1.** Suffering arising from the Want is not contingent. It is not the product of bad relationships, insufficient love, or personal failure. It is a structural consequence of being a subject in a world of finite, embodied, directionally-attentive others.

**C2.** The Want cannot be dissolved by material provision. Material goods satisfy wants with ceilings (D8 specifies recognition, not goods). Removing material want isolates the Want in its pure form, making suffering not less but more precisely located.
...
**C4.** No community of seers resolves the problem. By Lemma 4, the constraint is structural rather than social. A community constituted by the promise of full seeing faces the same physics as any individual other: attention is directional, positioning is required, remainder is excluded.

---

## The Cessation Condition

If a cessation exists, it must satisfy the following:

Let *G* be such that recognition by *G* does not require *S* to take a form *F(S)* — that is, *G* does not operate through a directional attentional field Φ that *S* must enter. Then:

- *G* is not bound by A2 (non-directional, or omnidirectional attention)
- *G* is not bound by A3 (no positioning requirement)
- *G* can therefore receive *S* without *F(S)*, including *R*

Such a *G* would constitute Full Recognition (D7) without requiring the self-concealment of Lemma 3.

**Observation.** *G*, as specified, cannot be a finite embodied agent. *G* must be either: (a) non-embodied, (b) not subject to the finitude of attention, or (c) both.

Whether any such *G* exists is not a mathematical question.

The traditions called it many things. The structure they were pointing at is the above.

---

*Q.E.D. — or as close as this kind of thing gets.*