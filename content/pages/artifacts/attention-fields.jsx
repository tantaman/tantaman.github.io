...
const HUES = {
  M: 340, D: 220, B: 45,
  F1: 150, F2: 270, F3: 180, F4: 120,
  N1: 25, N2: 195,
  W1: 250, W2: 10,
  L: 0,
  G: 48,
  P1: 30, P2: 70, P3: 100, P4: 135, P5: 200, P6: 240, P7: 285, P8: 315,
};
...
const HUB = [
  {
    label: 'Small Circle', short: 'Small',
    note: 'A few people, balanced mutual attention — everyone is seen',
    persons: {
      B:  { x: 0.50, y: 0.50, r: 0.075, att: { P1: 0.6, P2: 0.55, P3: 0.5 } },
      P1: { x: 0.30, y: 0.35, r: 0.06, att: { B: 0.6, P2: 0.3, P3: 0.25 } },
      P2: { x: 0.70, y: 0.35, r: 0.06, att: { B: 0.55, P1: 0.3, P3: 0.25 } },
      P3: { x: 0.50, y: 0.25, r: 0.055, att: { B: 0.5, P1: 0.25, P2: 0.25 } },
    },
  },
  {
    label: 'Growing', short: 'Growing',
    note: 'New people start attending to B — attention per person thins',
    persons: {
      B:  { x: 0.50, y: 0.50, r: 0.075, att: { P1: 0.45, P2: 0.4, P3: 0.35, P4: 0.3, P5: 0.25 } },
      P1: { x: 0.28, y: 0.35, r: 0.055, att: { B: 0.6, P2: 0.2 } },
      P2: { x: 0.72, y: 0.35, r: 0.055, att: { B: 0.55, P1: 0.15 } },
      P3: { x: 0.50, y: 0.22, r: 0.05, att: { B: 0.5 } },
      P4: { x: 0.30, y: 0.65, r: 0.05, att: { B: 0.55 } },
      P5: { x: 0.70, y: 0.65, r: 0.05, att: { B: 0.5 } },
    },
  },
  {
    label: 'Popular', short: 'Popular',
    note: 'Everyone attends to B — B\u2019s field is pulled in every direction at once',
    persons: {
      B:  { x: 0.50, y: 0.50, r: 0.07, att: { P1: 0.25, P2: 0.25, P3: 0.25, P4: 0.2, P5: 0.2, P6: 0.2, P7: 0.15 } },
      P1: { x: 0.22, y: 0.35, r: 0.05, att: { B: 0.65 } },
      P2: { x: 0.78, y: 0.35, r: 0.05, att: { B: 0.6 } },
      P3: { x: 0.50, y: 0.15, r: 0.045, att: { B: 0.6 } },
  ...
  {
    label: 'Platform', short: 'Platform',
    note: 'B\u2019s blob is a perfect shallow circle \u2014 reaching for everyone, holding no one',
    persons: {
      B:  { x: 0.50, y: 0.50, r: 0.065, att: { P1: 0.12, P2: 0.12, P3: 0.12, P4: 0.1, P5: 0.1, P6: 0.1, P7: 0.1, P8: 0.1 } },
      P1: { x: 0.20, y: 0.30, r: 0.045, att: { B: 0.7 } },
      P2: { x: 0.80, y: 0.30, r: 0.045, att: { B: 0.7 } },
      P3: { x: 0.50, y: 0.12, r: 0.04, att: { B: 0.65 } },
      P4: { x: 0.22, y: 0.70, r: 0.04, att: { B: 0.65 } },
      P5: { x: 0.78, y: 0.70, r: 0.04, att: { B: 0.65 } },
      P6: { x: 0.12, y: 0.50, r: 0.04, att: { B: 0.6 } },
      P7: { x: 0.88, y: 0.50, r: 0.04, att: { B: 0.6 } },
      P8: { x: 0.50, y: 0.85, r: 0.04, att: { B: 0.6 } },
    },
  },
  {
    label: 'Flattened', short: 'Flat',
  ...
  {
    label: 'Managed', short: 'Managed',
    note: 'Being seen everywhere = being known nowhere \u2014 B\u2019s field shrinks inward',
    persons: {
      B:  { x: 0.50, y: 0.50, r: 0.04, att: { P1: 0.05, P2: 0.05, P3: 0.05, P4: 0.05, P5: 0.05, P6: 0.05, P7: 0.05, P8: 0.05 } },
      P1: { x: 0.20, y: 0.30, r: 0.045, att: { B: 0.7 } },
      P2: { x: 0.80, y: 0.30, r: 0.045, att: { B: 0.7 } },
      P3: { x: 0.50, y: 0.12, r: 0.04, att: { B: 0.65 } },
      P4: { x: 0.22, y: 0.70, r: 0.04, att: { B: 0.65 } },
      P5: { x: 0.78, y: 0.70, r: 0.04, att: { B: 0.6 } },
      P6: { x: 0.12, y: 0.50, r: 0.04, att: { B: 0.6 } },
      P7: { x: 0.88, y: 0.50, r: 0.04, att: { B: 0.55 } },
      P8: { x: 0.50, y: 0.85, r: 0.04, att: { B: 0.55 } },
    },
  },
  {
    label: 'Exit', short: 'Exit',
    note: 'B withdraws \u2014 the crowd\u2019s fields still reach for where B was',
    persons: {
      B:  { x: 0.50, y: 0.50, r: 0.025, op: 0.3, att: {} },
      P1: { x: 0.20, y: 0.30, r: 0.045, att: { B: 0.6 } },
      P2: { x: 0.80, y: 0.30, r: 0.045, att: { B: 0.6 } },
      P3: { x: 0.50, y: 0.12, r: 0.04, att: { B: 0.55 } },
      P4: { x: 0.22, y: 0.70, r: 0.04, att: { B: 0.55 } },
      P5: { x: 0.78, y: 0.70, r: 0.04, att: { B: 0.5 } },
      P6: { x: 0.12, y: 0.50, r: 0.04, att: { B: 0.5 } },
      P7: { x: 0.88, y: 0.50, r: 0.04, att: { B: 0.45 } },
      P8: { x: 0.50, y: 0.85, r: 0.04, att: { B: 0.45 } },
    },
  },
];
...
const OSSIFICATION = [
  ...
  {
    label: 'Bonding', short: 'Bond',
    note: 'Attention weights increase \u2014 fields overlap more',
    persons: {
      B:  { x: 0.40, y: 0.55, r: 0.07, att: { F1: 0.55, F2: 0.5, F3: 0.5 } },
      F1: { x: 0.60, y: 0.55, r: 0.065, att: { B: 0.55, F2: 0.45, F3: 0.4 } },
      F2: { x: 0.55, y: 0.35, r: 0.06, att: { B: 0.5, F1: 0.45, F3: 0.4 } },
      F3: { x: 0.42, y: 0.35, r: 0.06, att: { B: 0.5, F1: 0.4, F2: 0.4 } },
    },
  },
  {
    label: 'Tight Circle', short: 'Tight',
  ...
  },
  {
    ...
    persons: {
      ...
      F2: { x: 0.54, y: 0.40, r: 0.07, att: { B: 0.8, F1: 0.75, F3: 0.7 } },
      F3: { x: 0.44, y: 0.40, r: 0.07, att: { B: 0.8, F1: 0.7, F2: 0.7 } },
    },
  },
  {
    label: 'Attempt', short: 'Attempt',
    ...
    persons: {
      ...
      F2: { x: 0.54, y: 0.40, r: 0.07, att: { B: 0.8, F1: 0.75, F3: 0.7 } },
      F3: { x: 0.44, y: 0.40, r: 0.07, att: { B: 0.8, F1: 0.7, F2: 0.7 } },
      N1: { x: 0.18, y: 0.70, r: 0.05, att: { B: 0.35 } },
    },
  },
  {
    label: 'Resistance', short: 'Resist',
    ...
    persons: {
      ...
      F2: { x: 0.54, y: 0.40, r: 0.07, att: { B: 0.75, F1: 0.75, F3: 0.7 } },
      F3: { x: 0.44, y: 0.40, r: 0.07, att: { B: 0.75, F1: 0.7, F2: 0.7 } },
      N1: { x: 0.15, y: 0.72, r: 0.055, att: { B: 0.45 } },
    },
  },
  {
    label: 'Snap Back', short: 'Snap',
...
const CASCADE = [
  ...
  },
  {
    ...
    persons: {
      ...
      F3: { x: 0.40, y: 0.65, r: 0.025, op: 0.4, att: {} },
      F4: { x: 0.30, y: 0.72, r: 0.02, op: 0.1, att: {} },
      L:  { x: 0.90, y: 0.25, r: 0.06, op: 0.3, att: {} },
    },
  },
  {
    label: 'Aftermath', short: 'After',
    note: 'Attention is not just scarce \u2014 it is load-bearing',
    persons: {
      B:  { x: 0.38, y: 0.48, r: 0.045, att: { F1: 0.1, F2: 0.08 } },
      F1: { x: 0.55, y: 0.40, r: 0.04, att: { B: 0.1 } },
...
export default function AttentionFields() {
  ...
  const labelText = nearest.age != null
