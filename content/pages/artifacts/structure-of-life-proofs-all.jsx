...
const tabList = [
  { key: 'main', label: 'The Proof', sub: 'D1–D8 · A1–A5 · T' },
  ...
  { key: 'violence', label: 'Social Theorem', sub: 'S1 · S2 · S3' },
  { key: 'gelassenheit', label: 'Gelassenheit', sub: 'The open door' },
];

export default function OldestWantProofs() {
    ...
    >
      ...
      <div className="header">
        <div className="header-top">
          <span className="header-title">The Oldest Want</span>
          <span className="header-divider">—</span>
          <span className="header-sub">
            Proof · Corollaries · Theorem · Gelassenheit
          </span>
        </div>
        <div className="tabs">
          {tabList.map((tab) => (
      ...
      {isGelassenheit ? (
        <>
          <div className={`col-headers single`}>
          ...
          <div>
            {current.sections.map((section, i) => (
              ...
              >
                ...
                <div className="gelassenheit-col">
