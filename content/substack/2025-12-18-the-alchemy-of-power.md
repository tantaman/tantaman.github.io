...
5.  Selection pressure favors interpretations that are _legible_, _enforceable_, _fundable_, and _identity-forming_
...
The Daoist classic _Daodejing_ goes further, explicitly warning that law itself breeds the disorder it claims to prevent:
...
> “Not this, not this” (_neti neti_)—ultimate reality escapes every category.
...
Buddhism follows the same arc. The _Dīpavaṁsa_ describes how oral teaching became written scripture:
...
Religion becomes court. And the _Pirkei Avot_ explicitly endorses interpretive expansion as a control mechanism:
...
Once a teaching becomes textual and institutional, it becomes _visible_ to power. And power always asks the same question: “Is this useful?”
...
**Registration** turns belonging into bureaucracy. Religious Daoism developed registers (_lu_) that tracked membership and rank—a parallel bureaucracy mirroring the state. The _Celestial Masters_ movement collected “five pecks of rice” as dues. Heaven was organized like earth.
...
-   Revolutionary movements develop manifestos (canon), then party discipline (clergy), then purges of heretics (inquisition)
    
-   Therapeutic insights become HR compliance training
    
-   Scientific discoveries become credentialed expertise become funding gatekeeping
    
-   Social movements generate “official” spokespeople and approved terminology
    

The mechanism is constant: any idea that moves people can be captured by structures that organize people. The sincere guardian, the procedural manager, and the ambitious patron form an alliance—sometimes explicit, usually unconscious—that selects for interpretations that are _legible_ (can be written down), _enforceable_ (can be monitored), _fundable_ (can attract resources), and _identity-forming_ (can distinguish us from them).
