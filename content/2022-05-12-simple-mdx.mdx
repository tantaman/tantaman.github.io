...
5. [remark-rehype](https://github.com/remarkjs/remark-rehype) - to convert the markdown ast to an html ast for further processing. Already included by `@mdx-js/mdx`.
6. [rehype-highlight](https://github.com/rehypejs/rehype-highlight) - to enable code highlighting
