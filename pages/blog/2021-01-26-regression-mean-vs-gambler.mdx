...
import '@site/static/blog-assets/regression-mean-vs-gambler.css';
...
<br />
<i data-bind="after_run_tails"></i> / <i data-bind="num_runs"></i> * 100 =<i data-bind="after_run_tails_pct"></i>
% <span class="coin side-T"></span>
