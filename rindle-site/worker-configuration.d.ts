/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1ab5702ec67389faf888b02fc3f4a70a)
// Runtime types generated with workerd@1.20260714.1 2026-07-21 nodejs_compat
interface __BaseEnv_Env {
	ATTACHMENTS_BUCKET: R2Bucket;
	AUTH_DB: D1Database;
	DHA_DB: D1Database;
	AUTH_TRUSTED_ORIGINS: "https://tantaman.com,https://tantamanlands.tantaman.workers.dev";
	RINDLE_URL: string;
	RINDLE_DATABASE_TOKEN: string;
	DHA_SECRET: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTH_TRUSTED_ORIGINS" | "RINDLE_URL" | "RINDLE_DATABASE_TOKEN" | "DHA_SECRET" | "DHA_ADMIN_SECRET">> {}
}
