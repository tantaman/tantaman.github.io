        ...
        <ResponsiveContainer width="100%" height={320}>
          <LineChart data={data} margin={{ left: 10, right: 20, top: 10, bottom: 5 }}>
            ...
            <Line
              ...
              stroke={T.teal}
              strokeWidth={2.5}
              dot={{ r: 3.5, fill: T.surface, stroke: T.teal, strokeWidth: 2 }}
              activeDot={{ r: 5, fill: T.teal }}
            />
            <Line
              type="monotone"
              dataKey="occasional"
              name="Occasional attenders"
              stroke={T.gold}
              strokeWidth={2.5}
              dot={{ r: 3.5, fill: T.surface, stroke: T.gold, strokeWidth: 2 }}
              activeDot={{ r: 5, fill: T.gold }}
            />
            <Line
              type="monotone"
              dataKey="nonreligious"
              name="Nonreligious"
              stroke={T.purple}
              strokeWidth={2.5}
              dot={{ r: 3.5, fill: T.surface, stroke: T.purple, strokeWidth: 2 }}
