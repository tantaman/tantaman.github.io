      ...
      <div style={{ padding: '16px 8px 8px' }}>
        <ResponsiveContainer width="100%" height={280}>
          <AreaChart data={data} margin={{ left: 10, right: 20, top: 10, bottom: 5 }}>
            <defs>
              <linearGradient id="uCurveFill" x1="0" y1="0" x2="0" y2="1">
            ...
            <Area
              ...
              strokeWidth={2.5}
              fill="url(#uCurveFill)"
              dot={{ r: 4, fill: T.surface, stroke: T.gold, strokeWidth: 2 }}
              activeDot={{ r: 6, fill: T.gold, stroke: T.surface, strokeWidth: 2 }}
            />
          </AreaChart>
        </ResponsiveContainer>
      </div>
