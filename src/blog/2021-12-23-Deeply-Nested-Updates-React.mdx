...
import deeplyNested from '@site/static/blog-assets/deeply-nested-updates/deeply-nested.png';
import deeplyNestedReRender from '@site/static/blog-assets/deeply-nested-updates/deeply-nested-re-render.png';
